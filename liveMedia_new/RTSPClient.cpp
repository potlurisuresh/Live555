...
unsigned RTSPClient::sendRequest(RequestRecord* request) {
  ...
  do {
    ...
    if (strcmp(request->commandName(), "DESCRIBE") == 0) {
      ...
      extraHeaders = (char*)"Content-Type: application/sdp\r\nVideo-payload: a=rtpmap:97 H264/90000|a=fmtp:97 profile-level-id=42001f;packetization-mode=1;sprop-parameter-sets=Z01AC9oEx/vhAAADAAEAAAMAHg8UKqA=,aM8yyA==\r\nAudio-payload: a=rtpmap:99 AMR/8000/1|a=fmtp:99 octet-align=1\r\n";
